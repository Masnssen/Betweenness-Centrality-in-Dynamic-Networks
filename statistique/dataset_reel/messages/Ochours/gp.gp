...
set output "courbe_1.png"

set ylabel "Le cout du sommet"
set xlabel "Closeness centrality"

# Obtenir les valeurs minimale et maximale de l'axe x
stats "cc_OCnodeslinks_clean_hours_1.test" using 4 nooutput
min_x = STATS_min
max_x = STATS_max

stats "cc_OCnodeslinks_clean_hours_1.test" using 3 nooutput 
min_y = STATS_min
max_y = STATS_max
...
plot "cc_OCnodeslinks_clean_hours_1.test" using (normalize_x($4)):(normalize_y($3)) with points pointtype 7